...
class KancolleStatus:
    def __init__(self, x=0, y=0):
        ...
        print 'x_base_rate: ', self.x_base_rate, self.y_base_rate
    ...
    def __init_btn(self):
        ...
        self.pos_map = {
            ...
            'youjun': (210, 42, 54, 12),
            'tujian': (290, 42, 54, 12),
            'shangdian': (375, 42, 54, 12),
            'fangjian': (450, 42, 54, 12),
            'renwu': (530, 42, 54, 12),
            ...
            'shezhi': (760, 440, 25, 20),  # 设置按钮

            # 补给页面
            'buji_quanbuji': (110, 110, 15, 15),
            'buji_1': (140, 110, 10, 10),
            'buji_2': (170, 110, 10, 10),
            'buji_3': (203, 110, 10, 10),
            'buji_4': (231, 110, 10, 10),
            ...
            # 远征页面
            'yz_01': (120, 164, 400, 10),
            'yz_02': (120, 194, 400, 10),
            'yz_03': (120, 224, 400, 10),
            'yz_04': (120, 254, 400, 10),
            'yz_05': (120, 284, 400, 10),
            'yz_06': (120, 314, 400, 10),
            'yz_07': (120, 344, 400, 10),
            'yz_08': (120, 374, 400, 10),
            'yz_d1': (114, 440, 20, 7),
            'yz_d2': (193, 440, 20, 7),
            'yz_d3': (244, 440, 20, 7),
            'yz_d4': (295, 440, 20, 7),
